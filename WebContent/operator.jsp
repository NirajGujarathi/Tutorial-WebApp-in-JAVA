...
<p><b>Operator</b> in java is a symbol that is used to perform operations. For example: +, -, *, / etc.<p>
<p> There are many types of operators in java which are given below:</p>
<ul >
<li>Unary Operator, </li><li>Arithmetic Operator, </li><li>shift Operator, </li><li>Relational Operator, </li><li>Bitwise Operator, </li><li>Logical Operator, </li><li>Ternary Operator and </li><li>Assignment Operator.</li></ul>
