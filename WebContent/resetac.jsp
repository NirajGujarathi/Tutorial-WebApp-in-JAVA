...
<form action="AddrecordsServlet" method="post">
<center>
<h1 align=center> Set New Password </h1>
<h4 align=center> Re-enter username: <input type="text" name="username" > <br></h4>
<br>
<h4 align=center> Enter new Password:  <input type="password" name="password"> <br>
<br>
</h4>

 <input type="submit" value="Set new password" height="50" width="100"> <br> 
</center>
</form>
